...
if (isset($_POST['submit'])) {
    ...
    $status = $_POST['status'];
    $insert_data = mysqli_query($conn, "INSERT INTO color_master(color, sel_color, status) VALUES ('$color', '$sel_color', '$status')");
                                ...
                                <div class="card-body">
                                    <div class="live-preview">
                                        <form class="row g-3" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-4">
                                                <label for="validationDefault01" class="form-label">Select Color</label>
                                                <input type="color" name="sel_color" class="form-control"
                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                                <thead class="table-light">
                                                    ...
                                                    <?php
                                                    $i = 0;
                                                    $sel_col_data = mysqli_query($conn, "SELECT * FROM color_master");
                                                    while ($fetch_data = mysqli_fetch_assoc($sel_col_data)) {
                                                        $i++;
                                                        ?>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td><?php echo $fetch_data['color']; ?></td>
                                                            <td><?php echo $fetch_data['sel_color']; ?></td>
