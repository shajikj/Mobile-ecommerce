...
<head>
    <meta charset="utf-8" />
    <title>Dashboard - Customer Master</title>
                                        ...
                                        <div class="table-responsive table-card">
                                            <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $i = 0;
                                                    $sel_customers = mysqli_query($conn, "SELECT 
                                                     user_id, full_name, phone, email, address, COUNT(order_id) AS total_orders FROM orders GROUP BY user_id ORDER BY user_id DESC");

                                                    while ($row = mysqli_fetch_assoc($sel_customers)) {
                                                        $i++;
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $i; ?></td>
